...
echo "<p>Generating 10 random Facebook times between 18:00 and 22:00 with 5-minute intervals:</p>\n";
echo "<ul>\n";
...
echo "<p>Generating 10 random Telegram times between 18:00 and 22:00 with 5-minute intervals:</p>\n";
echo "<ul>\n";
...
echo "<ul>\n";
echo "<li><strong>Facebook & Telegram:</strong> Between 18:00 and 22:00</li>\n";
echo "<li><strong>Intervals:</strong> 5-minute intervals (18:05, 18:10, 18:15, etc.)</li>\n";
echo "<li><strong>Randomness:</strong> Different each time the page is refreshed</li>\n";
echo "<li><strong>Independence:</strong> Facebook and Telegram times are generated independently</li>\n";
echo "</ul>\n";
