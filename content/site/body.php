...
<div id="nav_links">
    <a href="/<?php echo $_COOKIE['lang']; ?>/calculator">
        <div class="img" style="background-image:url(/media/images/links/link-1.jpg);"></div>
        <span class="ttl"><?php echo $lng['p']['services']['calc_customs']['name']; ?></span>
    </a>
    <a href="/<?php echo $_COOKIE['lang']; ?>/tradein">
        <div class="img" style="background-image:url(/media/images/links/link-2.jpg);"></div>
        <span class="ttl"><?php echo $lng['p']['services']['tradein']['name']; ?></span>
    </a>
    <a href="/<?php echo $_COOKIE['lang']; ?>/services/order">
        <div class="img" style="background-image:url(/media/images/links/link-3.jpg);"></div>
