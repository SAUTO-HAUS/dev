...
<div class="sale-page">
    <section class="sale-section sale-hero sale-section--accent sale-animate">
        <div class="sale-hero__content">
            ...
            <div class="sale-hero__cta">
                <a class="sale-btn sale-btn--primary sale-btn--pulse" href="/ru/contacts" data-sale-scroll="#sale-cta">Оставить заявку</a>
    ...
    <section class="sale-section sale-process sale-animate" id="sale-process">
        ...
        <div class="sale-timeline">
            <ol class="sale-timeline__list sale-scrollable" data-sale-scrollable>
                <li class="sale-timeline__item sale-animate"><span>Вы привозите автомобиль к нам в автосалон.</span></li>
                <li class="sale-timeline__item sale-animate"><span>Мы проводим визуальный осмотр и тест-драйв.</span></li>
                <li class="sale-timeline__item sale-animate"><span>Подписываем договор на оказание услуги.</span></li>
                <li class="sale-timeline__item sale-animate"><span>Авто проходит мойку и фотосъёмку.</span></li>
                <li class="sale-timeline__item sale-animate"><span>Размещаем объявления на 999.md, Facebook, Instagram, Telegram, TikTok.</span></li>
                <li class="sale-timeline__item sale-animate"><span>Ведём переговоры и показываем автомобиль покупателям.</span></li>
                <li class="sale-timeline__item sale-animate"><span>Организуем сделку и передаём вам деньги.</span></li>
            </ol>
    ...
    <section class="sale-section sale-cta sale-section--accent sale-animate" id="sale-cta">
        <div class="sale-cta__content">
            ...
            <a class="sale-btn sale-btn--primary" href="/ru/contacts">Оставить заявку</a>
        </div>
    </section>
</div>
