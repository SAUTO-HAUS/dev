...
<?php 
	...
	foreach ($pdo as $row){
		...
		<script type="application/ld+json">
		{
			...
			"image": "https://".$_SERVER['HTTP_HOST']."/media/images/upload/car/".$row['photo_path']."/".$row['id']."/med/".$c_photo_name.".jpg",
	...
	*/	
		...
		<script type="application/ld+json">
		{
			...
			"@type": "Vehicle",
			"name": "Ford C-MAX",
			"image": "https://".$_SERVER['HTTP_HOST']."/media/images/upload/car/05a5/751d/9bf3/6977/med/0aa3d4ceac7d2e5f90eb96c8921270a6.jpg",
			"productionDate": "2013",
			"bodyType": "Universal",
		...
		<script type="application/ld+json">
		{
			...
			"@type": "AutoDealer",
			"name": "Sauto.md",
			"image": "https://".$_SERVER['HTTP_HOST']."/media/images/site/sauto_new_logo.png",
			"legalName": "Sauto SRL",
			"telephone": "+373 68 689 995 , +373 69 977 674",
			...
			"makesOffer" : {
				...
				"itemOffered" : {
					"@type": "Car",
					"name": "Ford C-MAX",
					"image": "https://".$_SERVER['HTTP_HOST']."/media/images/upload/car/05a5/751d/9bf3/6977/high/0aa3d4ceac7d2e5f90eb96c8921270a6.jpg",
					"modelDate": "2013",
					"bodyType": "Universal",
					"mileageFromOdometer": "167000 km",
					"vehicleEngine" : {
