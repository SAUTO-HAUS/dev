...
try {
    ...
    $allTranslations = [
        'ro' => [
            ...
            'fl' => ['gsl'=>'Benzină', 'gmn'=>'Benzină / Gaz (metan)', 'gpn'=>'Benzină / Gaz (propan)', 'hbd'=>'Hybrid', 'dsl'=>'Diesel', 'pih'=>'Plug-in Hybrid', 'pid'=>'Plug-in Hybrid (diesel)', 'elc'=>'Electricitate', 'gas'=>'Gaz'],
        ...
        'ru' => [
            ...
            'fl' => ['gsl'=>'Бензин', 'gmn'=>'Бензин / Газ (метан)', 'gpn'=>'Бензин / Газ (пропан)', 'hbd'=>'Гибрид', 'dsl'=>'Дизель', 'pih'=>'Plug-in Гибрид', 'pid'=>'Плагин-гибрид (дизель)', 'elc'=>'Электричество', 'gas'=>'Газ'],
