	...
	foreach ($f_arr['brmo']['mo'] as $v) {
		...
		<div class="ctrl">';
			...
			<div class="btns" data-link="/'.$_COOKIE['lang'].'/ordercars/" data-def="/'.$_COOKIE['lang'].'/ordercars">
				...
				<a class="btn sbmt" href="/'.$_COOKIE['lang'].'/ordercars'.$q_uri.'" data-gr="'.(isset($_GET['gr'])?$_GET['gr']:'').'" data-br="'.(isset($_GET['br'])?$_GET['br']:'').'" data-mo="'.(isset($_GET['mo'])?$_GET['mo']:'').'" data-bt="'.(isset($_GET['bt'])?$_GET['bt']:'').'"';
