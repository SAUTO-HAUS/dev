...
<div id="p_cont" class="base">
	<div class="pg bg">
		...
		<div class="gr">
			...
			<p><b>2.1.</b> Vânzătorul execută livrarea autovehiculului către Cumpărător, întocmește și transmite Cumpărătorului documentele corespunzătoare necesare pentru înregistrarea dreptului de proprietate la Agenția Servicii Publice, în decurs de 25 (Douazeci si cinci) zile lucratoare din momentul semnării prezentului contract, cu condiția îndeplinirii de către Cumpărător a tuturor obligațiunilor ce îi revin in punctul 3.3. Toate cheltuielel ce țin de întocmirea certificatului de înmatriculare și a altor taxe adiționale ca: impozitul rutier anual, plata pentru revizia tehnica precum și asigurarea sînt suportate de Cumpărător.</p>
	...
	<div class="pg bg x1">
		<div class="gr">
			<h3 class="ttl">6. ALTE CLAUZE.</h3>
			<p><b>6.1.</b> Prezentul contract este întocmit în limba română, în trei exemplare (câte un exemplar pentru fiecare parte, Vânzător și Cumpărător, ASP), care produc aceleași efecte juridice. Părțile înțeleg în întregime obiectul prezentului contract și convin ca orice modificări la acesta să fie întocmite în formă scrisă în mod anticipat.</p>
			<p><b>6.2.</b> Părţile se obligă să soluționeze orice litigii pe calea negocierilor amiabile. Părțile stabilesc și sunt de acord ca termenul de înaintare a pretențiilor care decurg din prezentul contract, este de 15 zile calendaristice, de la data primirii acestora. în cazul în care Părțile nu ajung la un consens, litigiile sunt soluționate de către o instanță competentă a Republicii Moldova.</p>
			<p><b>6.3.</b> Cumpărătorul exprimă consimțământul pentru prelucrarea și folosirea de către Vânzător și/sau persoana autorizată pentru deservirea tehnică, datelor cu caracter personal (în special, doar ne limitându-se - numele si prenumele, adresa poștală, numărul de telefon , email, locul de munca si etc.) în scopul informării Cumpărătorului și suportului relațiilor de contact în cadrul contractului încheiat.</p>
			<p><b>6.4.</b> Prezentul contract este confidențial.</p>
			<p><b>6.5.</b> Prezentul contract întră în vigoare la data semnării acestuia de către ambele părți și este valabil pînă la executarea sa în întregime.</p>
			<p><b>6.6.</b> La prezentul contract se anexează:</p>
			<p class="sb"><b>6.6.1.</b> Anexa nr.1 - Actul de primire-predare.</p>
		</div>
		<div class="flx">
			<div id="chap7_txt">';
				if ( isset($_POST['txt7']) ){
					...
					<div class="gr">';
						$i = 1;
						foreach ($_POST['txt7'] as $v){
							if ($v!=''){
								if ($i==1){$rtrn .= '<h3 class="ttl">7. EXTRA.</h3>';}
								$rtrn .= '
								<p><b>7.'.$i.'.</b> '.$v.'</p>';
								$i++;
							}
	...
	<div class="pg bg x2">
		<div class="flx">
			<div class="head">
				...
				<div class="nr">Contractul de vânzare-cumpărare nr. VC'.$cont_y.$cont_q.'/'.$cont_n.'__din_'.$zdate.'</div>
