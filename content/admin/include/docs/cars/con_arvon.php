...
<div id="p_cont" class="base">
	<div class="pg bg">
		...
		<div class="gr">
			<p><b>1.</b> Părţile reies din faptul că intenţiile lor corespund cu încheierea contractului de vînzare-cumpărare a autovehiculul de model <span class="txtln">&nbsp;&nbsp;<span class="txt_cpt">'.(isset($_POST['br'])?ucwords(strtolower(str_replace('_', ' ', $_POST['br']))):'').' '.(isset($_POST['mo'])?ucwords(str_replace('_', ' ', $_POST['mo'])):'').'</span>&nbsp;&nbsp;</span> de pe terenul pentru expunere "SAUTO" SRL.</p>
		</div>
		<div class="gr">
		...
		<div class="flx">
			...
			<div class="sign">
				...
				<div class="s2"><span class="txt_cpt">'.strtolower($_POST['u_nm']).'</span><span style="position: absolute;bottom: -7mm; font-size: 1rem;">IDNO: '.($_POST['u_cf_idno'] ?? '').'</span><div class="ln"></div></div>
			</div>
		</div>
	</div>';
