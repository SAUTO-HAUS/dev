	...
	<html>
		<head>
			...
			<style>
				...
				.base > .pg {width:'.(isset($_POST['doc_f']) && $_POST['doc_f']=='foaie_parcurs' ? '297mm' : '210mm').'; margin:0 auto; padding:'.(isset($_POST['doc_f']) && $_POST['doc_f']=='foaie_parcurs' ? '5mm' : '5mm 10mm').'; background-color:#fff; position:relative;}
