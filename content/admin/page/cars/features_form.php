                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div style="background: white; border: 1px solid #e0e0e0; border-radius: 6px; padding: 15px;">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                            <button type="button" id="prev_month" style="background: #6c757d; color: white; border: none; padding: 5px 10px; border-radius: 4px; cursor: pointer;">‹</button>
                            <h6 id="calendar_month_year" style="margin: 0; color: #495057; font-weight: 600;"></h6>
                            <button type="button" id="next_month" style="background: #6c757d; color: white; border: none; padding: 5px 10px; border-radius: 4px; cursor: pointer;">›</button>
                        </div>
                        
                        <!-- Calendar Grid -->
                        <div id="calendar_grid" style="display: grid; grid-template-columns: repeat(7, 1fr); gap: 2px; text-align: center;">
