...
<div class="stock-summary">
    ...
    <div class="summary-grid">
        ...
        <div class="summary-item">
            ...
            <span class="summary-value summary-clickable" data-category="main_active" style="cursor: pointer;"><?= $totals['main_active'] ?></span>
        </div>
        <div class="summary-item">
            <span class="summary-label"><?= $stock_lang['main_inactive'] ?>:</span>
            <span class="summary-value summary-clickable" data-category="main_inactive" style="cursor: pointer;"><?= $totals['main_inactive'] ?></span>
        </div>
        <div class="summary-item">
            <span class="summary-label"><?= $stock_lang['branch_active'] ?>:</span>
            <span class="summary-value summary-clickable" data-category="branch_active" style="cursor: pointer;"><?= $totals['branch_active'] ?></span>
        </div>
        <div class="summary-item">
            <span class="summary-label"><?= $stock_lang['branch_inactive'] ?>:</span>
            <span class="summary-value summary-clickable" data-category="branch_inactive" style="cursor: pointer;"><?= $totals['branch_inactive'] ?></span>
        </div>
    </div>
</div>
...
const carData = {
    ...
    main_active: <?= json_encode($cars_main_active) ?>,
    main_inactive: <?= json_encode($cars_main_inactive) ?>,
    branch_active: <?= json_encode($cars_branch_active) ?>,
    branch_inactive: <?= json_encode($cars_branch_inactive) ?>
};
    ...
    summaryClickables.forEach(function(element) {
        element.addEventListener('click', function() {
            ...
            cars.forEach(function(carId) {
                const url = baseUrl + '/' + lang + '/cars/' + carId;
