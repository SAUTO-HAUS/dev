...
if ( $_POST ){
	if ($_POST['src']=='adm'){
		...
		$zCur = isset($_POST['cur_'.$_POST['cur']])?$lng['l']['cur'][ $_POST['cur'] ]:$_POST['cur'];
		echo '
		<!DOCTYPE html>
		<html>
			<head>
				...
				<div class="bx prc">';
					if ($_POST['exchange']>$_POST['prc'] && $_POST['prc']<999999){echo '
						<div class="chng">
							...
							<span class="i2">'.$_POST['exchange'].' '.$zCur.'</span>
						</div>';
					}
					echo '
					<div class="value">
					...
					if ( isset($_POST['cur_'.$_POST['cur']]) ){echo '
						<div class="cnvrt">
							<span class="i1">VALOAREA IN LEI: ~'.(number_format($_POST['prc'] * $_POST['cur_'.$_POST['cur']], 0)).' MDL</span>
