...
foreach ($pdo as $r){
	...
	$ar[$i]['g:link'] = 'https://www.sauto.md/ro/ordercars/'.$r['id'];
...
$rss['channel'] = ['title'=>'Sauto, cars feed - Orders', 'link'=>[ '@attributes'=>['rel'=>'self', 'href'=>'https://www.sauto.md/ro/ordercars'] ]];
$rss['channel']['item'] = $ar;
