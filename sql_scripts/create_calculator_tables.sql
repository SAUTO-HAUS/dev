...
-- Diesel
('diesel', 0, 1500, 0, 2, 11.30),
('diesel', 0, 1500, 3, 4, 14.12),
('diesel', 0, 1500, 5, 6, 16.94),
('diesel', 0, 1500, 7, 7, 19.77),
('diesel', 0, 1500, 8, 8, 22.59),
('diesel', 0, 1500, 9, 9, 25.41),
('diesel', 0, 1500, 10, 0, 28.24),

('diesel', 1501, 2000, 0, 2, 18.83),
('diesel', 1501, 2000, 3, 4, 23.53),
('diesel', 1501, 2000, 5, 6, 28.24),
('diesel', 1501, 2000, 7, 7, 32.94),
('diesel', 1501, 2000, 8, 8, 37.65),
('diesel', 1501, 2000, 9, 9, 42.36),
('diesel', 1501, 2000, 10, 0, 47.06),

('diesel', 2001, 2500, 0, 2, 22.59),
('diesel', 2001, 2500, 3, 4, 28.24),
('diesel', 2001, 2500, 5, 6, 33.89),
('diesel', 2001, 2500, 7, 7, 39.53),
('diesel', 2001, 2500, 8, 8, 45.18),
('diesel', 2001, 2500, 9, 9, 50.83),
('diesel', 2001, 2500, 10, 0, 56.48),

('diesel', 2501, 3000, 0, 2, 30.12),
('diesel', 2501, 3000, 3, 4, 37.65),
('diesel', 2501, 3000, 5, 6, 45.18),
('diesel', 2501, 3000, 7, 7, 52.71),
('diesel', 2501, 3000, 8, 8, 60.24),
('diesel', 2501, 3000, 9, 9, 67.77),
('diesel', 2501, 3000, 10, 0, 75.30),

('diesel', 3001, 0, 0, 2, 45.18),
('diesel', 3001, 0, 3, 4, 56.48),
('diesel', 3001, 0, 5, 6, 67.77),
('diesel', 3001, 0, 7, 7, 79.07),
('diesel', 3001, 0, 8, 8, 90.36),
('diesel', 3001, 0, 9, 9, 101.66),
('diesel', 3001, 0, 10, 0, 112.95),
